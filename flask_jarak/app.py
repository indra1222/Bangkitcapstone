...
# Route untuk prediksi dengan metode GET
...
# Route untuk prediksi dengan metode POST
...
def predict_post():
    try:
        ...
        if not data or 'distance' not in data or 'rate' not in data:
            return jsonify({
                'error': 'Data input tidak valid. Pastikan terdapat field "distance" dan "rate".'
            }), 400
